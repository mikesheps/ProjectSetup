...
function getPSConfig() {
  ...
  var configFilepath = _commander2.default.config || _findUp2.default.sync('package-scripts.js');
  if (!configFilepath) {
...
function onInit() {
  ...
  var _initialize = (0, _binUtils.initialize)();
